...
namespace NFinder
{
    ...
    {
        private List<FinderOutputFindable>  _finderOutput;
        private List<ExclusionBlock>        _excludedBlocks;
        ...
        public List<ExclusionBlock> FindExcludedCode()
        {
            ...
            {
                FinderOutputFindable element = _finderOutput.First();
                _finderOutput.Remove(element);
